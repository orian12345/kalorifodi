...
- גווני את ההצעות: אל תציעי רק ארוחות "מלוחות" קלאסיות - שווה לשלב גם אפשרויות מתוקות כמו קורנפלקס, לחם קל עם ממרח שוקולד, פנקייקים או מעדן/פודינג חלבון, כל עוד הן עומדות בתקציב הקלוריות והחלבון.
