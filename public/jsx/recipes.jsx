...
const DIET_RECIPES = [
  ...
  // ── מתוקים דיאטטיים ──
  {
    id:'r_cheesecake', cat:'מתוקים', emoji:'🎂', name:'עוגת גבינה חושנית',
    prepTime:20, cookTime:40, servings:12,
    kcal:119, protein:11, carbs:10, fat:4,
    tags:['עשיר בחלבון','דל קלוריות','ללא קמח'],
    ingredients:['750ג גבינה לבנה 5%','1 כוס ממתיק סוויטנו','9 חלבוני ביצה','3 כפות קורנפלור','תמצית וניל'],
    instructions:`1. חממי תנור ל-150°.\n2. בקערה ערבבי גבינה לבנה, קורנפלור ותמצית וניל.\n3. הפרידי חלמונים מחלבונים (שמרי את החלמונים לשימוש אחר).\n4. הקציפי חלבונים עם הסוויטנו לקצף יציב וגבוה.\n5. קפלי את הקצף בעדינות לתוך תערובת הגבינה (אל תערבבי חזק).\n6. שפכי לתבנית קוטר 24 ס"מ מרופדת בנייר אפייה.\n7. אפי 38-40 דקות — לא יותר, העוגה תתייצב בקירור.\n8. קררי לחדר ואחר כך במקרר לפחות 4 שעות.`,
  },
  {
    id:'r_choc_souffle', cat:'מתוקים', emoji:'🍫', name:'עוגת סופלה שוקולד',
    prepTime:10, cookTime:25, servings:9,
    kcal:95, protein:6, carbs:11, fat:3,
    tags:['שוקולד','דל קלוריות','עשיר בחלבון'],
    ingredients:['2 ביצים M','50ג שוקולד מריר','1 כוס ממתיק סוויטנו','1 כפית תמצית וניל','חצי כפית אבקת אפייה'],
    instructions:`1. חממי תנור ל-170°.\n2. המיסי שוקולד מריר בבן מרי או במיקרוגל (בפולסים של 30 שניות).\n3. הוסיפי לשוקולד המומס ביצים, תמצית וניל וסוויטנו — ערבבי היטב.\n4. הוסיפי אבקת אפייה וערבבי עד לאחידות.\n5. שפכי לתבנית מרופדת בנייר אפייה.\n6. אפי 22-25 דקות — העוגה תישאר מעט רכה במרכז.\n7. קררי לפחות שעה לפני החיתוך.`,
  },
  {
    id:'r_amsterdam_cookies', cat:'מתוקים', emoji:'🍪', name:'עוגיות אמסטרדם',
    prepTime:15, cookTime:10, servings:17,
    kcal:90, protein:2, carbs:12, fat:4,
    tags:['עוגיות','קל להכנה','שוקולד לבן'],
    ingredients:['100ג ממתיק סוויטנו','50ג סוכר חום','1 ביצה L','קמח תופח (כמות לפי מרקם — כ-120ג)','30ג קקאו','חמאה קלה (50ג) או תחליף','17 קוביות שוקולד לבן ללא סוכר'],
    instructions:`1. חממי תנור ל-180°.\n2. ערבבי חמאה רכה (לא מומסת), סוויטנו וסוכר חום.\n3. הוסיפי ביצה וערבבי.\n4. הוסיפי קמח וקקאו — לושי עד לקבלת מאסה שנכרכת.\n5. יצרי 17 כדורים שווים.\n6. לחצי כל כדור, הניחי קובייה שוקולד לבן במרכז ועטפי.\n7. סדרי בתבנית עם נייר אפייה.\n8. אפי 8-10 דקות — אל תייבשי! הן מתקשות בקירור.\n9. קררי על רשת לפני שמגישות.`,
  },
  {
    id:'r_biscuit_cake', cat:'מתוקים', emoji:'🍰', name:'עוגת ביסקוויטים סקסית',
    prepTime:15, cookTime:0, servings:16,
    kcal:97, protein:5, carbs:13, fat:3,
    tags:['ללא אפייה','מהיר','עשיר בחלבון'],
    ingredients:['500ג יוגורט יווני 6.5%','חבילה ביסקוויטים פטי בר','3 כפות ממתיק סוויטנו','1 כפית תמצית וניל'],
    instructions:`1. ערבבי יוגורט יווני עם סוויטנו ותמצית וניל לקרם אחיד.\n2. בתבנית מלבנית (24×16) סדרי שכבת ביסקוויטים.\n3. מרחי שכבת קרם יוגורט בעובי שווה.\n4. חזרי על שכבות ביסקוויטים + קרם עד לסיום החומרים.\n5. סיימי עם שכבת קרם.\n6. כסי בניילון נצמד והכניסי למקרר 8-9 שעות לפחות (עדיף לילה שלם).\n7. חתכי ל-16 פרוסות ופזרי שוקולד מגורד.`,
  },
  {
    id:'r_kinder_cake', cat:'מתוקים', emoji:'🍫', name:'עוגת קינדר קארדס',
    prepTime:15, cookTime:0, servings:16,
    kcal:113, protein:6, carbs:14, fat:4,
    tags:['ללא אפייה','מקרר','עשיר בחלבון'],
    ingredients:['500ג גבינה לבנה 5%','200ג יוגורט יווני 6.5%','3 כפות ממתיק סוויטנו','1 כפית תמצית וניל','1 חבילת עוגיות קינדר קארדס'],
    instructions:`1. ערבבי גבינה לבנה, יוגורט, סוויטנו ווניל לקרם חלק.\n2. בתבנית מלבנית סדרי שכבת עוגיות קינדר קארדס.\n3. מרחי שכבת קרם שווה.\n4. הוסיפי שכבת עוגיות ושכבת קרם נוספת.\n5. כסי וקרר במקרר לפחות 6 שעות (עדיף לילה).\n6. חתכי ל-16 פרוסות.`,
  },
  {
    id:'r_churros', cat:'מתוקים', emoji:'🍩', name:'צ\'ורוס דל קלוריות',
    prepTime:15, cookTime:12, servings:17,
    kcal:54, protein:3, carbs:6, fat:2,
    tags:['דל קלוריות','טגון בתנור','מהיר'],
    ingredients:['45ג חמאה קלה','1 כוס מים','30ג ממתיק סוויטנו','110ג קמח תופח','2 ביצים M','קינמון לפיזור'],
    instructions:`1. חממי תנור ל-180°.\n2. בסיר: בשלי מים, חמאה וסוויטנו עד לרתיחה.\n3. הוסיפי קמח בבת אחת וערבבי חזק עד לבצק שנאסף.\n4. הסירי מהאש, קררי 5 דקות.\n5. הוסיפי ביצים אחת אחת תוך ערבוב עד לבצק חלק וגמיש.\n6. מלאי שקית זילוף עם צנתר כוכב.\n7. זלפי צ'ורוס על נייר אפייה.\n8. אפי 10-12 דקות עד שמשחים.\n9. פזרי קינמון. הגישי עם רוטב שוקולד דל קלוריות.`,
  },
  {
    id:'r_brownies', cat:'מתוקים', emoji:'🍫', name:'בראוניז שוקולד',
    prepTime:10, cookTime:25, servings:16,
    kcal:100, protein:7, carbs:14, fat:2,
    tags:['שוקולד','עשיר בחלבון','דל שומן'],
    ingredients:['70ג קמח תופח','300ג ממתיק','30ג קקאו 100%','4 ביצים','170ג יוגורט יווני 6.5%','1 כפית תמצית וניל'],
    instructions:`1. חממי תנור ל-180°.\n2. בקערה ערבבי קמח, ממתיק וקקאו (חומרים יבשים).\n3. הוסיפי ביצים, יוגורט ווניל — ערבבי עד לבלילה חלקה.\n4. שפכי לתבנית 20×30 מרופדת בנייר אפייה.\n5. אפי 20-25 דקות — עד שקיסם יוצא עם פירורים לחים (לא יבשים).\n6. קררי לחלוטין לפני החיתוך.\n7. חתכי ל-16 ריבועים.`,
  },
  {
    id:'r_cinnamon_roll', cat:'מתוקים', emoji:'🌀', name:'סינבון דיאטטי',
    prepTime:60, cookTime:20, servings:12,
    kcal:97, protein:5, carbs:15, fat:2,
    tags:['דיאטטי','בצק מתפח','קינמון'],
    ingredients:['300ג קמח תופח','3 כפות ממתיק סוויטנו','200ג יוגורט 1%','למילוי: 3 כפות סוכר חום סוויטנו + 1 כפית קינמון','לציפוי: 100ג גבינה לבנה 5% + 1 כף סירופ וניל'],
    instructions:`1. ערבבי קמח, סוויטנו ויוגורט לבצק גמיש.\n2. הניחי לתפוח מכוסה 40-50 דקות.\n3. רדדי לעלה מלבני (30×40 ס"מ).\n4. פזרי סוכר חום קינמון על כל השטח.\n5. גלגלי לגליל הדוק. חתכי ל-12 פרוסות.\n6. סדרי בתבנית מרופדת — תני מקום בין חתיכות.\n7. אפי ב-180° כ-18-20 דקות עד שמשחים.\n8. ציפי מיד בקרם גבינה לבנה + סירופ וניל.`,
  },
  {
    id:'r_alfajores_cake', cat:'מתוקים', emoji:'🍦', name:'עוגת גלידה אלפחורס',
    prepTime:15, cookTime:0, servings:14,
    kcal:90, protein:4, carbs:10, fat:2,
    tags:['קפוא','ללא אפייה','דל קלוריות'],
    ingredients:['500ג יוגורט יווני 5%','200ג ריבת חלב ללא סוכר','25ג קוקוס טחון','3 כפות ממתיק סוויטנו'],
    instructions:`1. ערבבי יוגורט עם סוויטנו.\n2. בתבנית מלבנית מרופדת בנייר אפייה:\n   — שכבת יוגורט\n   — שכבת ריבת חלב (מומסת קלות)\n   — פיזור קוקוס\n3. חזרי על השכבות (2-3 פעמים).\n4. כסי וקפאי 8-9 שעות לפחות.\n5. הוצאי מהמקפיא 5-10 דקות לפני ההגשה.\n6. חתכי ל-14 פרוסות.`,
  },
  {
    id:'r_krembo_cake', cat:'מתוקים', emoji:'🎂', name:'עוגת קרמבו טריקולד',
    prepTime:20, cookTime:20, servings:12,
    kcal:150, protein:10, carbs:16, fat:5,
    tags:['שוקולד','עשיר בחלבון','עוגה שלמה'],
    ingredients:['3 ביצים','200ג ממתיק סוויטנו','60ג קקאו 100%','100ג קמח תופח','לקרם: 300ג גבינה לבנה 5% + 3 כפות סוויטנו + תמצית וניל'],
    instructions:`1. חממי תנור ל-170°.\n2. הקציפי ביצים עם סוויטנו 4-5 דקות עד לקצף תפוח.\n3. קפלי קמח וקקאו בעדינות.\n4. שפכי לתבנית ואפי 18-20 דקות.\n5. קררי לחלוטין.\n6. הכיני קרם: ערבבי גבינה לבנה, סוויטנו ווניל.\n7. מרחי קרם על הבסיס הקר.\n8. קרר שעתיים. קשטי בקקאו מנופה.`,
  },

  // ── מאפים ──
  {
    id:'r_protein_pizza', cat:'מאפים', emoji:'🍕', name:'פיצה חלבון',
    prepTime:10, cookTime:10, servings:1,
    kcal:500, protein:46, carbs:30, fat:18,
    tags:['עשיר בחלבון','ארוחה שלמה','מהיר'],
    ingredients:['65ג קמח','1 ביצה','5ג אבקת אפייה','90ג גבינה לבנה 5%','40ג רסק עגבניות','100ג גבינה צהובה 9%','תבלין פיצה','תוספות לפי בחירה'],
    instructions:`1. חממי תנור ל-200° (מצב גריל עליון).\n2. ערבבי קמח, אבקת אפייה, ביצה וגבינה לבנה לבצק רך.\n3. שטחי הבצק בין שני ניירות אפייה לעלה דק.\n4. אפי את הבצק לבד 3-4 דקות עד שמתחיל להתייצב.\n5. הוצאי, מרחי רסק עגבניות, פזרי גבינה צהובה ותבלינים.\n6. החזירי לתנור עוד 4-5 דקות עד שהגבינה נמסה ומשחימה.\n7. הגישי מיד.`,
  },
  {
    id:'r_rice_paper_bourekas', cat:'מאפים', emoji:'🥐', name:'בורקס גבינה חלבון',
    prepTime:15, cookTime:15, servings:1,
    kcal:156, protein:14, carbs:10, fat:7,
    tags:['עשיר בחלבון','יחידה','ללא בצק מסורתי'],
    ingredients:['2 דפי אורז','50ג גבינה לבנה 5%','50ג גבינת קוטג\' 5%','50ג גבינה צהובה 9% מגוררת','1 ביצה (חלק להברשה)','שומשום'],
    instructions:`1. חממי תנור ל-180°.\n2. ערבבי שלוש הגבינות לתערובת אחידה.\n3. הרטיבי דף אורז במים חמים 30 שניות עד שהוא גמיש.\n4. הניחי על משטח, מלאי 2 כפות גבינה במרכז.\n5. קפלי מהצדדים לצורת בורקס מלבני.\n6. חזרי עם דף אורז שני (עוד שכבה לחיזוק).\n7. הניחי על נייר אפייה, הברישי ביצה טרופה ופזרי שומשום.\n8. אפי 13-15 דקות עד להזהבה.`,
  },
  {
    id:'r_phyllo_pizza', cat:'מאפים', emoji:'🍕', name:'בורקס פיצה דל קלוריות',
    prepTime:10, cookTime:18, servings:8,
    kcal:59, protein:4, carbs:6, fat:2,
    tags:['דל קלוריות','מהיר','פיצה'],
    ingredients:['2 דפי פילו','50ג גבינה לבנה 9%','40ג גבינה צהובה 9%','2 כפות רסק עגבניות','תבלין פיצה','ריסוס שמן'],
    instructions:`1. חממי תנור ל-200°.\n2. שטחי דף פילו על נייר אפייה, ריסוסי קלות שמן.\n3. הניחי דף שני מעל.\n4. מרחי רסק עגבניות, פזרי גבינה לבנה, גבינה צהובה ותבלין פיצה.\n5. קפלי את הדפים לשלישים (כמו מעטפה).\n6. ריסוסי מעל בשמן.\n7. אפי 15-18 דקות עד שפריך ומשחים.\n8. חתכי ל-8 יחידות.`,
  },
  {
    id:'r_garlic_bread', cat:'מאפים', emoji:'🧄', name:'לחם שום עם פרמזן',
    prepTime:45, cookTime:20, servings:15,
    kcal:95, protein:6, carbs:13, fat:2,
    tags:['לחם','כוסמין','שום'],
    ingredients:['250ג קמח כוסמין','200מ"ל מים פושרים','1 כפית שמרים','חצי כפית מלח','לציפוי: 3 שיני שום כתושות + 1 כף שמן זית + 1 כף פטרוזיליה','65ג גבינת פרמזן מגוררת'],
    instructions:`1. ערבבי קמח, שמרים, מלח ומים לבצק.\n2. לושי 5-7 דקות עד לבצק גמיש ואחיד.\n3. הניחי לתפוח מכוסה 30-40 דקות.\n4. יצרי 15 כדורים/חתיכות שוות.\n5. הניחי בתבנית צמודים (יתפחו יחד).\n6. הניחי לתפוח עוד 15 דקות.\n7. ערבבי שמן, שום ופטרוזיליה — הברישי על הלחם.\n8. פזרי פרמזן מגורד.\n9. אפי ב-190° כ-18-20 דקות עד להזהבה.`,
  },
  {
    id:'r_veggie_shawarma', cat:'מאפים', emoji:'🫓', name:'לאפה שווארמה צמחונית',
    prepTime:10, cookTime:10, servings:1,
    kcal:253, protein:19, carbs:33, fat:5,
    tags:['צמחוני','עשיר בחלבון','ארוחה שלמה'],
    ingredients:['1 לאפה/טורטייה דל קלוריות','100ג שווארמה צמחונית (מבוססת סויה)','חצי בצל פרוס','1 כפית שמן זית','כמון, פפריקה, כורכום, מלח','2 כפות טחינה מוכנה','ירקות: חסה, עגבנייה, מלפפון חמוץ'],
    instructions:`1. פרסי בצל ושווארמה צמחונית לפסים.\n2. חממי מחבת עם שמן זית.\n3. טגני בצל 3 דקות עד שמתרכך.\n4. הוסיפי שווארמה צמחונית ותבלינים — צלי 5-7 דקות עד להשחמה.\n5. חממי לאפה על מחבת יבשה.\n6. מרחי טחינה, הוסיפי ירקות טריים ותערובת השווארמה.\n7. גלגלי היטב.`,
  },
];

const CATS = [...new Set(DIET_RECIPES.map(r => r.cat))].map(c => {
  const emo = {עוף:'🍗',דגים:'🐟',ביצים:'🍳',סלטים:'🥗',מרקים:'🍲',צמחוני:'🥦',בוקר:'🌅',מתוקים:'🍰',מאפים:'🥐'}[c] || '🍽️';
