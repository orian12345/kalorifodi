...
(function () {
  ...
  const FOODS = [
    ...
    { id:'bread_pro',      name:'לחם פרו (פרוטאין)',   icon:'🍞', serving:'פרוסה',      kcal:64,  p:8,  c:5,  f:1,  grams:30  },
    ...
    { id:'pita_pro',       name:'פיתה פרו (פרוטאין)',  icon:'🫓', serving:'יחידה',      kcal:130, p:17, c:10, f:1,  grams:68  },
    ...
    // ── דגנים ודיסות ──
    { id:'oats',           name:'שיבולת שועל',         icon:'🥣', serving:'50ג יבש',    kcal:190, p:7,  c:33, f:3,  grams:50,  units:[{label:'כף', grams:8}]  },
    { id:'granola',        name:'גרנולה',              icon:'🥣', serving:'50ג',        kcal:220, p:5,  c:35, f:7,  grams:50,  units:[{label:'כף', grams:10}] },
    { id:'cornflakes',     name:'קורנפלקס',            icon:'🥣', serving:'30ג',        kcal:115, p:2,  c:26, f:0,  grams:30,  units:[{label:'כף', grams:3}]  },
    { id:'musli',          name:'מוסלי',               icon:'🥣', serving:'50ג',        kcal:195, p:6,  c:35, f:4,  grams:50,  units:[{label:'כף', grams:10}] },
    { id:'rice_cakes',     name:'עוגות אורז',          icon:'🫙', serving:'2 יחידות',   kcal:70,  p:1,  c:15, f:0,  grams:18  },
    { id:'buckwheat',      name:'כוסמת מבושלת',        icon:'🌾', serving:'100ג',       kcal:92,  p:3,  c:20, f:1,  grams:100, units:[{label:'כף', grams:15}] },
    { id:'bulgur',         name:'בורגול מבושל',        icon:'🌾', serving:'100ג',       kcal:83,  p:3,  c:18, f:0,  grams:100, units:[{label:'כף', grams:15}] },
    { id:'couscous',       name:'קוסקוס מבושל',        icon:'🌾', serving:'100ג',       kcal:112, p:4,  c:23, f:0,  grams:100, units:[{label:'כף', grams:15}] },
    { id:'millet',         name:'דוחן מבושל',          icon:'🌾', serving:'100ג',       kcal:119, p:3,  c:24, f:1,  grams:100, units:[{label:'כף', grams:15}] },
    { id:'semolina',       name:'סולת',                icon:'🌾', serving:'30ג',        kcal:105, p:4,  c:22, f:0,  grams:30,  units:[{label:'כף', grams:10}] },
    { id:'wheat_germ',     name:'נבט חיטה',            icon:'🌾', serving:'2 כפות',     kcal:45,  p:3,  c:6,  f:1,  grams:14  },

    // ── אורז ופסטה ──
    { id:'rice',           name:'אורז לבן מבושל',      icon:'🍚', serving:'כוס',        kcal:205, p:4,  c:45, f:0,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'rice_brown',     name:'אורז מלא מבושל',      icon:'🍚', serving:'כוס',        kcal:215, p:5,  c:45, f:2,  grams:195, units:[{label:'כף', grams:15}] },
    { id:'rice_basmati',   name:'אורז בסמטי',          icon:'🍚', serving:'כוס',        kcal:200, p:4,  c:44, f:0,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'pasta',          name:'פסטה מבושלת',         icon:'🍝', serving:'כוס',        kcal:220, p:8,  c:43, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'pasta_whole',    name:'פסטה מלאה מבושלת',    icon:'🍝', serving:'כוס',        kcal:200, p:8,  c:40, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'spaghetti',      name:'ספגטי מבושל',         icon:'🍝', serving:'כוס',        kcal:220, p:8,  c:43, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'noodles',        name:'אטריות ביצה',         icon:'🍜', serving:'כוס',        kcal:220, p:8,  c:40, f:3,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'rice_noodles',   name:'אטריות אורז',         icon:'🍜', serving:'כוס',        kcal:190, p:3,  c:43, f:0,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'quinoa',         name:'קינואה מבושלת',       icon:'🌾', serving:'כוס',        kcal:220, p:8,  c:39, f:4,  grams:185, units:[{label:'כף', grams:15}] },
    ...
    { id:'cheese_white5',  name:'גבינה לבנה 5%',       icon:'🧀', serving:'100ג',       kcal:105, p:9,  c:4,  f:5,  grams:100, units:[{label:'כף', grams:25}] },
    { id:'cheese_white9',  name:'גבינה לבנה 9%',       icon:'🧀', serving:'100ג',       kcal:140, p:8,  c:4,  f:9,  grams:100, units:[{label:'כף', grams:25}] },
    ...
    { id:'butter',         name:'חמאה',                icon:'🧈', serving:'כף',         kcal:100, p:0,  c:0,  f:11, grams:14, units:[{label:'כפית', grams:5}] },
    { id:'butter_light',   name:'חמאה קלה',            icon:'🧈', serving:'כף',         kcal:70,  p:0,  c:0,  f:8,  grams:14, units:[{label:'כפית', grams:5}] },
    ...
    { id:'chicken_schnitzel',name:'שניצל עוף מטוגן',   icon:'🍗', serving:'150ג',       kcal:320, p:35, c:14, f:13, grams:150 },
    { id:'chicken_schnitzel_oven',name:'שניצל עוף בתנור', icon:'🍗', serving:'150ג',    kcal:245, p:33, c:12, f:6,  grams:150 },
    { id:'pargiyot',       name:'פרגיות',              icon:'🍗', serving:'150ג',       kcal:280, p:27, c:3,  f:18, grams:150 },
    ...
    { id:'turkey_schnitzel',name:'שניצל הודו מטוגן',   icon:'🦃', serving:'150ג',       kcal:290, p:38, c:12, f:9,  grams:150 },
    { id:'turkey_schnitzel_oven',name:'שניצל הודו בתנור', icon:'🦃', serving:'150ג',   kcal:220, p:36, c:12, f:4,  grams:150 },
    ...
    { id:'eggplant_fried', name:'חצילים מטוגנים',     icon:'🍆', serving:'100ג',       kcal:110, p:1,  c:9,  f:7,  grams:100 },
    { id:'eggplant_baked', name:'חצילים בתנור',       icon:'🍆', serving:'100ג',       kcal:60,  p:1,  c:9,  f:3,  grams:100 },
    ...
    { id:'tehina',         name:'טחינה גולמית',        icon:'🫙', serving:'כף',         kcal:89,  p:3,  c:3,  f:8,  grams:15, units:[{label:'כפית', grams:5}] },
    { id:'tahini_ready',   name:'טחינה מוכנה',         icon:'🫙', serving:'כף',         kcal:60,  p:2,  c:3,  f:5,  grams:15, units:[{label:'כפית', grams:5}] },
    ...
    { id:'peanutbutter',   name:'חמאת בוטנים',         icon:'🥜', serving:'כף',         kcal:95,  p:4,  c:3,  f:8,  grams:16, units:[{label:'כפית', grams:5}] },
    { id:'almond_butter',  name:'חמאת שקדים',          icon:'🌰', serving:'כף',         kcal:98,  p:3,  c:3,  f:9,  grams:16, units:[{label:'כפית', grams:5}] },
    ...
    // ── שמנים ורטבים ──
    { id:'olive_oil',      name:'שמן זית',             icon:'🫒', serving:'כף',         kcal:120, p:0,  c:0,  f:14, grams:14, units:[{label:'כפית', grams:5}] },
    ...
    { id:'honey',          name:'דבש',                 icon:'🍯', serving:'כף',         kcal:64,  p:0,  c:17, f:0,  grams:21, units:[{label:'כפית', grams:7}] },
    { id:'jam',            name:'ריבה',                icon:'🍓', serving:'כף',         kcal:55,  p:0,  c:14, f:0,  grams:20, units:[{label:'כפית', grams:7}] },
    ...
    { id:'chocolate_spread',name:'ממרח שוקולד',        icon:'🍫', serving:'כף',         kcal:100, p:1,  c:12, f:6,  grams:20, units:[{label:'כפית', grams:7}] },
    { id:'nutella',         name:'ממרח נוטלה',         icon:'🍫', serving:'כף',         kcal:108, p:1,  c:12, f:6,  grams:20, units:[{label:'כפית', grams:7}] },
    { id:'hashachar_class', name:'ממרח שוקולד השחר קלאסי', icon:'🍫', serving:'כף',    kcal:101, p:1,  c:13, f:5,  grams:20, units:[{label:'כפית', grams:7}] },
    { id:'hashachar_parve', name:'ממרח שוקולד השחר פרווה', icon:'🍫', serving:'כף',    kcal:109, p:1,  c:13, f:6,  grams:20, units:[{label:'כפית', grams:7}] },
    ...
    { id:'ptitim',         name:'פתיתים מבושלים',      icon:'🌾', serving:'כוס',        kcal:215, p:7,  c:45, f:1,  grams:200, units:[{label:'כף', grams:15}] },
    ...
    { id:'white_cheese_30',name:'גבינה לבנה 30%',      icon:'🧀', serving:'100ג',       kcal:280, p:7,  c:3,  f:27, grams:100, units:[{label:'כף', grams:25}] },
    ...
    // ── סוגי פסטות ──
    { id:'penne',            name:'פנה מבושלת',            icon:'🍝', serving:'כוס',        kcal:220, p:8,  c:43, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'farfalle',         name:'פרפלה מבושלת',          icon:'🍝', serving:'כוס',        kcal:215, p:8,  c:42, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'rigatoni',         name:'ריגטוני מבושל',         icon:'🍝', serving:'כוס',        kcal:220, p:8,  c:43, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'fusilli',          name:'פוסילי מבושל',          icon:'🍝', serving:'כוס',        kcal:215, p:8,  c:42, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'linguine',         name:'לינגוויני מבושל',       icon:'🍝', serving:'כוס',        kcal:220, p:8,  c:43, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'tagliatelle',      name:'טליאטלה מבושלת',        icon:'🍝', serving:'כוס',        kcal:215, p:7,  c:42, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'gnocchi',          name:'ניוקי',                 icon:'🍝', serving:'כוס',        kcal:250, p:6,  c:51, f:2,  grams:180, units:[{label:'כף', grams:15}] },
    ...
    { id:'pasta_fresh',      name:'פסטה טרייה',            icon:'🍝', serving:'כוס',        kcal:265, p:9,  c:50, f:3,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'pasta_gf',         name:'פסטה ללא גלוטן',        icon:'🍝', serving:'כוס',        kcal:210, p:4,  c:44, f:1,  grams:140, units:[{label:'כף', grams:15}] },
    { id:'orzo',             name:'אורזו מבושל',           icon:'🍝', serving:'כוס',        kcal:213, p:7,  c:43, f:1,  grams:140, units:[{label:'כף', grams:15}] },

    // ── סוגי אורז ──
    { id:'rice_jasmine',     name:'אורז יסמין',            icon:'🍚', serving:'כוס',        kcal:205, p:4,  c:44, f:0,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'rice_arborio',     name:'אורז ארבוריו',          icon:'🍚', serving:'כוס',        kcal:210, p:4,  c:46, f:0,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'rice_wild',        name:'אורז בר',               icon:'🍚', serving:'כוס',        kcal:166, p:7,  c:35, f:1,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'rice_red',         name:'אורז אדום',             icon:'🍚', serving:'כוס',        kcal:215, p:5,  c:45, f:2,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'rice_black',       name:'אורז שחור',             icon:'🍚', serving:'כוס',        kcal:220, p:5,  c:46, f:2,  grams:160, units:[{label:'כף', grams:15}] },
    { id:'rice_sticky',      name:'אורז דביק',             icon:'🍚', serving:'כוס',        kcal:215, p:4,  c:47, f:0,  grams:160, units:[{label:'כף', grams:15}] },
    ...
    { id:'rice_vermicelli',  name:'אורז עם שעורית',        icon:'🍚', serving:'כוס',        kcal:230, p:5,  c:48, f:2,  grams:165, units:[{label:'כף', grams:15}] },

    // ── פתיתים ──
    { id:'ptitim_whole',     name:'פתיתים מלאים',          icon:'🌾', serving:'כוס',        kcal:195, p:8,  c:40, f:1,  grams:200, units:[{label:'כף', grams:15}] },
    { id:'ptitim_color',     name:'פתיתים צבעוניים',       icon:'🌾', serving:'כוס',        kcal:215, p:7,  c:45, f:1,  grams:200, units:[{label:'כף', grams:15}] },
    ...
    { id:'schnitzel_beef',      name:'שניצל בקר מטוגן',     icon:'🥩', serving:'150ג',    kcal:380, p:35, c:14, f:20, grams:150 },
    { id:'schnitzel_beef_oven', name:'שניצל בקר בתנור',    icon:'🥩', serving:'150ג',    kcal:320, p:33, c:12, f:16, grams:150 },
    ...
    { id:'pro_zero_choc',    name:'מעדן פרו זירו שוקולד', icon:'🍮', serving:'גביע',       kcal:123, p:13, c:12, f:2,  grams:150 },
    { id:'pro_zero_white',   name:'מעדן פרו זירו שוקולד לבן', icon:'🍮', serving:'גביע',  kcal:123, p:13, c:12, f:2,  grams:150 },
    ...
    { id:'protein_maxx_chips', name:'פרוטאין צ׳יפס (Protein Maxx)', icon:'🍟', serving:'שקית', kcal:323, p:20, c:43, f:12, grams:72 },
    { id:'pro_energy_bar',   name:'חטיף חלבון Pro Energy', icon:'🍫', serving:'יחידה',      kcal:227, p:22, c:15, f:9,  grams:60  },
    { id:'allin_bar',        name:'חטיף חלבון Allin',     icon:'🍫', serving:'יחידה',      kcal:208, p:20, c:14, f:8,  grams:40  },
    { id:'allin_cookie',     name:'עוגיית חלבון Allin',   icon:'🍪', serving:'יחידה',      kcal:212, p:15, c:23, f:9,  grams:60  },
    { id:'nugo_bar',         name:'חטיף חלבון NuGo',      icon:'🍫', serving:'יחידה',      kcal:200, p:12, c:25, f:7,  grams:50  },
    { id:'today_crispy',     name:'חטיף חלבון Today Crispy', icon:'🍫', serving:'יחידה',   kcal:190, p:18, c:15, f:7,  grams:51  },
    { id:'grenade_bar',      name:'חטיף חלבון Grenade',   icon:'🍫', serving:'יחידה',      kcal:220, p:21, c:14, f:8,  grams:60  },
    ...
    // ── שוקולד ללא סוכר ──
    { id:'sf_choc_white',    name:'שוקולד לבן ללא סוכר',  icon:'🍫', serving:'שורה',       kcal:83,  p:1,  c:9,  f:6,  grams:17  },
